...
main() {
    ...
    echo ""
    echo "  Gateway port and token are read from ~/.openclaw/openclaw.json automatically."
    echo "  Override with OPENCLAW_GATEWAY_PORT / OPENCLAW_GATEWAY_TOKEN in ~/.swat/.env if needed."
    echo ""
