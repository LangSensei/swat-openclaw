...
Write-Host ""
Write-Host "  Gateway port and token are read from ~/.openclaw/openclaw.json automatically."
Write-Host "  Override with OPENCLAW_GATEWAY_PORT / OPENCLAW_GATEWAY_TOKEN in ~/.swat/.env if needed."
Write-Host ""
